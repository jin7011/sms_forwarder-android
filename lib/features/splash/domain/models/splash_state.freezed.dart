...
/// @nodoc
mixin _$SplashState {
  SplashStep get step => throw _privateConstructorUsedError;
...
class _$SplashStateImpl extends _SplashState {
  const _$SplashStateImpl(
      {this.step = SplashStep.initial,
      this.statusText = '앱을 시작하는 중...',
      this.isLoading = true,
      this.errorMessage})
      : super._();
  ...
  @override
  String toString() {
    return 'SplashState(step: $step, statusText: $statusText, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, step, statusText, isLoading, errorMessage);
